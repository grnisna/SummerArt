      ...
      <div className="lg:flex justify-between items-center" >
        <div className='lg:mt-14  mt-3'>
          ...
          <div className='flex items-center'>
            ...
            <div onClick={handleShare} className="flex items-center mx-5">  < FaShare color={share ? 'green' : 'gray'} /> <button className="mx-2 font-bold text-primary">Share  </button> </div>
        ...
        <div className="flex items-center">
          <div className="w-96" > <img src={image1}/> </div>
          <div >
            <div className="w-48 m-0" >  <img src={image1}/> </div>
            <div className="w-48 m-0" > <img src={image1}/> </div>
          </div>
        </div>
